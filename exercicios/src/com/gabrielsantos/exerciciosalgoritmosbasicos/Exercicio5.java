...
public class Exercicio5 {
	...
	public static void main(String[] args) {
		...
		if (existeMaior == false) {
			System.out.println(primeiroValor + " e " + segundoValor + " são múltiplos!");
		} else {
			if ((maior % menor) == 0) {
				System.out.println(maior + " e " + menor + " são múltiplos!");
			} else {
				System.out.println(primeiroValor + " e " + segundoValor + " não são múltiplos!");
			}
		}
	}
}
